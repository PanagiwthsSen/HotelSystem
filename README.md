...
Το **Grand Kavala Hotel System** είναι μια πλήρης web εφαρμογή διαχείρισης ξενοδοχείου που αναπτύχθηκε ως εργασία για το μάθημα Τεχνολογία Λογισμικού 2. Καλύπτει τον πλήρη κύκλο λειτουργίας ενός ξενοδοχείου: από την online κράτηση δωματίου από έναν επισκέπτη έως την αποχώρησή του, καθώς και όλες τις εσωτερικές διαδικασίες του προσωπικού (housekeeping, minibar, μεταφορές, κηπουρική, μισθοδοσία, αναφορές εσόδων).
